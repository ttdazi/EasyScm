...
public class ClassUtils {
    ...
    private static SharedPreferences getMultiDexPreferences(Context context) {
        return context.getSharedPreferences("multidex.version", Context.MODE_MULTI_PROCESS);
    }
        ...
        while (var3.hasNext()) {
            ...
            try {
                ...
                while (dexEntries.hasMoreElements()) {
                    ...
                    Log.e("ClassclassName", className);
    ...
    public static List<String> getSourcePaths(Context context) throws NameNotFoundException, IOException {
        ...
        Log.i("getSourcePaths", applicationInfo.sourceDir + "..." + extractedFilePrefix);
        if (!isVMMultidexCapable()) {
            int totalDexNumber = getMultiDexPreferences(context).getInt("dex.number", 1);
            File dexDir = new File(applicationInfo.dataDir, SECONDARY_FOLDER_NAME);
            Log.i("getSourcePaths_dexDir", dexDir.getAbsolutePath() + "..." + totalDexNumber);
            for (int secondaryNumber = 2; secondaryNumber <= totalDexNumber; ++secondaryNumber) {
                ...
                Log.i("getSourcePaths_seco", extractedFile.getAbsolutePath() + "...");
